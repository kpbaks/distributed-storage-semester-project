...
def store_file(file_data, send_task_socket, response_socket):
    ...
    file_data_1 = file_data
    #file_data_2 = file_data[math.ceil(size/2.0):]

    # Generate two random chunk names for each half
    file_data_1_names = [random_string(8), random_string(8),random_string(8), random_string(8)]
...
"""
    ...
    return file_data_1_names

def get_file(part1_filenames, data_req_socket, response_socket):
    """
